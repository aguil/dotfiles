...
| Git behavior               | diff/merge defaults (`kdiff3`/`nvimdiff`), delta pager, core options, global ignores | credential helper and keychain integration                   | `user.name`, `user.email`, signing key                        | work/personal identity split is required                                                                      |
