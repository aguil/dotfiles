...
This folder contains scripts and exported artifacts for backing up
machine-specific Windows config.
...
- Review diffs before committing in case local app settings include
  machine-specific values you do not want to track.
